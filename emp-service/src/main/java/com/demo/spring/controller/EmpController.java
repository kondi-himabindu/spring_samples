...
public class EmpController {
	...
	@RequestMapping(path="/empSalary", method = RequestMethod.GET, produces={MediaType.APPLICATION_JSON_VALUE})
	public List<Employee> getEmployeesBySal(@RequestParam("sal") double sal){
		List<Employee> e = (List<Employee>) dao.getAllBySalary(sal);
		return e;
	}
